...
func (s *rpcServer) validateOrder(ctx context.Context, order order.Order,
	acct *account.Account, auctionTerms *terms.AuctioneerTerms) error {
...
func (s *rpcServer) SubmitOrder(ctx context.Context,
	...
	if err := s.validateOrder(ctx, o, acct, auctionTerms); err != nil {
...
func (s *rpcServer) OfferSidecar(ctx context.Context,
	...
	if req.AutoNegotiate {
		...
		err = s.validateOrder(ctx, bid, acct, auctionTerms)
		if err != nil {
			return nil, err
		}
	}
...
func (s *rpcServer) RegisterSidecar(ctx context.Context,
	...
	if registeredTicket.Offer.Auto {
		err := s.server.sidecarAcceptor.AutoAcceptSidecar(ctx, registeredTicket)
		if err != nil {
...
func (s *rpcServer) expectSidecarChannel(ctx context.Context,
	...
	err := validateOfferedTicket(ctx, t, s.lndServices.Signer, s.server.db)
	if err != nil {
		return err
	}
